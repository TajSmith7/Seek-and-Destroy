...
void AHitScanWeapon::Fire(const FVector& HitTarget)
{
	...
	if (MuzzleFlashSocket )
	{
		...
		if (ShooterCharacter && InstigatorController)
		{
			...
			if (HasAuthority() && bCauseAuthoritativeDamage && ShooterCharacter != OwnerPawn)
			{
		...
		if (FireHit.GetActor() != ShooterCharacter && FireHit.GetActor() != OwnerPawn && HasAuthority() && InstigatorController)
		{
